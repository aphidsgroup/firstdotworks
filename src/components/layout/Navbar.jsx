...
export default function Navbar() {
  ...
  return (
    <>
      <header className={`sticky top-0 bg-white/80 dark:bg-dark-bg/80 backdrop-blur-xl border-b border-surface-border dark:border-dark-border transition-all duration-300 ${scrolled ? 'h-16' : 'h-20'} ${open ? 'z-[100]' : 'z-50'}`}>
        <div className="container-xl h-full">
          <div className="flex items-center justify-between h-full">
            ...
            <Link to="/" className="flex items-center gap-2.5 flex-shrink-0 relative group">
              ...
              <img src="/logo.png" alt="Firstdot Works" className={`${scrolled ? 'h-10' : 'h-14'} w-auto relative z-10 transition-all duration-500 dark:invert dark:brightness-200 object-contain`} />
            </Link>
      ...
      {open && (
        <div className="lg:hidden fixed inset-0 z-[9999] animate-fade-in flex flex-col overflow-hidden">
          ...
          <div className="relative w-[85%] max-w-sm h-full bg-white dark:bg-[#0B0F19] shadow-2xl flex flex-col animate-slide-right border-r border-surface-border dark:border-dark-border">
            <div className="h-20 flex items-center px-8 border-b border-surface-border dark:border-dark-border bg-gray-50/50 dark:bg-white/5">
               <img src="/logo.png" alt="Firstdot Works" className="h-14 w-auto dark:invert dark:brightness-200 object-contain" />
            </div>
